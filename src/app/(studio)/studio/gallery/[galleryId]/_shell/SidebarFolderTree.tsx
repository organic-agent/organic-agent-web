        ...
        return (
          <div key={concept.id}>
            ...
            >
              ...
              <span aria-hidden className="ml-1 h-px flex-1 bg-divider-default" />
            </button>
            {!closed && (
              <ul>
                  ...
                  return (
                    <li key={detail.id}>
                      <button
                        ...
                        className={`relative flex w-full cursor-pointer items-center gap-2 rounded-(--radius-8) py-2 pr-2.5 pl-3.5 text-left type-content-m transition-colors duration-fast hover:bg-surface-default-lightness ${
                          selected
