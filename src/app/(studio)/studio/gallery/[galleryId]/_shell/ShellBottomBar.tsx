        ...
        <div className="flex items-center gap-2">
          ...
          {onDeleteSelection && (
            <button
              ...
              className="inline-flex h-10 cursor-pointer items-center gap-1.5 rounded-(--radius-8) border border-border-default px-4 type-label-medium-m text-function-error-default transition-colors duration-fast hover:border-function-error-default hover:bg-function-error-background"
            >
